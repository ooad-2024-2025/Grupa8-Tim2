...
namespace K_K.Controllers
{
    public class ProizvodController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv,Opis,Slika,Cijena")] Proizvod proizvod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv,Opis,Slika,Cijena")] Proizvod proizvod)
        {
            if (id != proizvod.Id)
            {
                return NotFound();
